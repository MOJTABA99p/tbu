...
"""
################################################################################
api_id = 23422623 # ایدی مخصوص اکانت خودتون قرار بدید
api_hash = "1ab66e50352af36516d66ef08ff0f596" #هش مخصوص اکانت خودتون قرار بدید
...
#    draw.text(((W - wt) / 2, (H - ht) / 2 ), text, font=font, fill=choice(["#00c7a4","#0071c7","#c7a200","#728593","#943633","#6495ed","#43f70a","#e1b2ae","#527130","#629f5d","#3d4e90",
